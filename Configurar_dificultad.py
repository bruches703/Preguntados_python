...
boton_facil = crear_elemento_juego("Imagenes/Botones/boton_g.png",ANCHO_BOTON_DIFICULTAD,ALTO_BOTON_DIFICULTAD,POS_X_BOTON_DIF,POS_Y_BOTON_DIF)
boton_normal = crear_elemento_juego("Imagenes/Botones/boton_g.png",ANCHO_BOTON_DIFICULTAD,ALTO_BOTON_DIFICULTAD,POS_X_BOTON_DIF, POS_Y_BOTON_DIF + 200)
boton_dificil = crear_elemento_juego("Imagenes/Botones/boton_g.png",ANCHO_BOTON_DIFICULTAD,ALTO_BOTON_DIFICULTAD,POS_X_BOTON_DIF, (POS_Y_BOTON_DIF + 200) + 200)
    ...
    for evento in cola_eventos:
        if evento.type == pygame.QUIT:
            ...
            if boton_volver["rectangulo"].collidepoint(evento.pos):
                ...
                CLICK_SONIDO.play()
                # Aquí podrías cambiar la dificultad si querés:
